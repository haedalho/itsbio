...
export default function AboutPage() {
  return (
    <main className="bg-white">
      ...
      <section id="ceo-message" className="mx-auto max-w-6xl px-6 pt-10 md:pt-14">
      ...
      <section id="about-content" className="mx-auto max-w-6xl px-6 pb-16 pt-12 md:pt-14">
        <div className="max-w-3xl">
          <p className="text-sm leading-7 text-slate-600 md:text-base">
            ITS BIO는 필요한 제품을 정확하게 확인하고, 필요한 시점에 안정적으로 공급하는 것을 기본으로 생각합니다.
            견적·납기·대체 옵션을 명확하게 정리하고 발주부터 배송까지 연구 현장의 커뮤니케이션 부담을 줄입니다.
          </p>
