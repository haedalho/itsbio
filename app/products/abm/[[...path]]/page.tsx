        ...
        {nodes.map((node) => {
          ...
          return (
            <div key={node.key}>
              ...
              >
                <span className="min-w-0">{stripBrandSuffix(node.title)}</span>
                {hasChildren ? (
                  <span className={isOpen ? theme.accentText : "text-neutral-300 group-hover:text-neutral-500"} aria-hidden>
                    {isOpen ? "⌃" : "⌄"}
                  </span>
                ) : (
