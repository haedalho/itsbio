...
export default function TumorCellLinesPage() {
  ...
  return <CellLibraryShell title="Tumor Cell Lines" active="tumor-cell-lines">
    ...
    <ImmortalizedCatalogClient products={products.slice(0, 12)} initialTotal={products.length} initialModelType="Tumor Cells" />
  </CellLibraryShell>;
}
