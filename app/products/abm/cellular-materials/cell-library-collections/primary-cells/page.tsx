...
export default function PrimaryCellsPage() {
  ...
  return <CellLibraryShell title="Primary Cells" active="primary-cells">
    ...
    <ImmortalizedCatalogClient products={products.slice(0, 12)} initialTotal={products.length} initialModelType="Primary Cells" />
  </CellLibraryShell>;
}
