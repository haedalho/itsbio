...
export default function HscPage() {
  return <CellLibraryShell title="Hematopoietic Stem Cell (HSC)" active="hematopoietic-cells" subActive="hematopoietic-stem-cell-hsc">
    ...
    <section className="mt-7"><h2 className="text-[22px] font-semibold text-[#414b55]">Product List</h2><div className="mt-4 overflow-hidden rounded-md border border-neutral-200"><table className="w-full border-collapse text-left text-[13px]"><thead><tr className="bg-neutral-50"><th className="px-4 py-3">Product Name</th><th className="px-4 py-3">Cat. No.</th><th className="px-4 py-3">Unit</th></tr></thead><tbody><tr className="border-t border-neutral-200"><td className="px-4 py-3"><Link href="/products/abm/staged/product/T4164" className="font-semibold text-[#d95628]">Hematopoietic Stem Cells</Link></td><td className="px-4 py-3">T4164</td><td className="px-4 py-3">1×10⁶ Cells</td></tr><tr className="border-t border-neutral-200"><td className="px-4 py-3"><Link href="/products/abm/staged/product/TM181" className="font-semibold text-[#d95628]">PrimGrow Xpan™ Medium Kit</Link></td><td className="px-4 py-3">TM181</td><td className="px-4 py-3">500 ml</td></tr></tbody></table></div></section>
  </CellLibraryShell>;
}
