...
export default async function Cas9ExpressingCellLinesPage({ searchParams }: { searchParams?: Promise<{ q?: string; page?: string }> | { q?: string; page?: string } }) {
  ...
  const records = await getSpecialAbmCellCatalog("cas9");
  ...
  return <CellLibraryShell title="Cas9 Expressing Cell Lines" active="cas9-expressing-cell-lines">
    ...
    <section className="mt-8 border-t border-neutral-200 pt-8"><SectionTitle eyebrow="Find your model" title="Search and filter Cas9-expressing cell lines" text="Browse by product name, catalogue number, species, bio system, or tissue." /></section>
